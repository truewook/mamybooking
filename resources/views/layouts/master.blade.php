                    ...
                    <div class="topnav">
                        <ul class="quick-menu pull-right clearfix">
                            ...
                            <li class="ribbon">
                                <a href="#" title="">USD</a>
                                <ul class="menu mini">
                                    <li><a href="#" title="€ Euro">AUD</a></li>
                                    <li><a href="#" title="€ Euro">BRL</a></li>
                                    <li class="active"><a href="#" title="$US Dollar">USD</a></li>
                                    <li><a href="#" title="€ Euro">CAD</a></li>
                                    <li><a href="#" title="€ Euro">CHF</a></li>
                                    <li><a href="#" title="€ Euro">CNY</a></li>
                                    <li><a href="#" title="€ Euro">CZK</a></li>
                                    <li><a href="#" title="€ Euro">DKK</a></li>
                                    <li><a href="#" title="€ Euro">EUR</a></li>
                                    <li><a href="#" title="€ Euro">GBP</a></li>
                                    <li><a href="#" title="€ Euro">HKD</a></li>
                                    <li><a href="#" title="€ Euro">HUF</a></li>
                                    <li><a href="#" title="€ Euro">IDR</a></li>
                                </ul>
                            </li>
                            <li class="ribbon">
